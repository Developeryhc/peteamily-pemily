		...
		<div class="body">
			...
			<br><br><br>
				...
				<div class="moto2">
					<div>
						<h2>봉사</h2>
						<h4>주기적인 유기동물보호소 봉사와</h4>
						<h4> 후원으로 사회적 공헌 및 활동</h4>
					</div>
					<div>
						<h2>전문</h2>
...
소비자 애견 피해보상 규정과 동물보호법을
준수하며, 나아가 도의적인 책임까지 최대한 소비자의
입장에서 생각함으로써 대한민국 반려문화 선진화에 앞장서고
있습니다.
						</pre>
					</div>
				</div><br>
...
성장할 수 있었습니다.
				...
				<div class="promise">
					...
					<div class="text">
						...
						<pre>
Pemily의 모토이자 목표인 4가지 약속을 
항상 실천하며 평생의 반려가족을 맞이할 고객님들께
