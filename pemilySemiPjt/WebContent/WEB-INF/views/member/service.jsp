...
<body>
    <div class="container">	
        <h1 class="title">이용약관(공정거래위원회 표준 약관)</h1>
        <div class="body">	
            <div style="width:94%; height:580px; overflow:auto; line-height:18px; border:1px solid #f68735; padding:3%; margin:0 auto">
                <strong>제1조(목적) </strong><br />
        이 약관은 (유)내고향시푸드(전자거래 사업자)이 운영하는 홈페이지(이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 (유)내고향시푸드와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. <br />
