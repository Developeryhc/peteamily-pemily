			...
			<form action="/nModifyFrm" class="nModifyFrm" method="post">
				<div class="writerInfo-wrap">
						...
						<div class="writerInfo">
							<span class="noticeViewTitle"><input type="text" id="nModifyTitle" name="noticeTitle" value="<%=nwi.getNoticeTitle() %>"></span>
							<div>
				...
				<div class="mdBtn-wrap"><button type="button" class="mdBtn completeBtn" value="<%=nwi.getNoticeNo() %>">완료</button><button type="button" class="mdBtn cancelBtn" value="<%=nwi.getNoticeNo() %>">취소</button></div>
				<input type="hidden" name="noticeNo" value="<%=nwi.getNoticeNo() %>">
				<input type="hidden" name="noticeWriter" value="<%=nwi.getNoticeWriter() %>">
